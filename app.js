(() => {
  ...
  const open = () => { music.play().catch(()=>{}); $('musicControl').classList.add('visible'); $('invitation').hidden = false; $('cover').classList.add('open'); setTimeout(()=>$('cover').remove(),1200); };
  ...
  function reveal(){revealed=true;canvas.style.transition='opacity .7s';canvas.style.opacity=0;hint.style.opacity=0;petalPop();}
